...
- If you are replacing the DDS images with the repack function, then make sure that the DDS compression/Pixel format used in your image file is supported by the games. refer this [texture format](https://github.com/LR-Research-Team/Datalog/wiki/TRB#texture-format) page to get a list of supported formats.
