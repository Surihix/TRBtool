...
- If you are replacing the DDS images with the repack function, then make sure that the DDS compression/Pixel format used in your image file is the same as what it was in the original file.
